...
<div class="min-h-screen pb-1 bg-gray-100 flex items-center justify-center">
            ...
            <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                    <div class="text-gray-600">
                        <p class="font-medium text-lg">Creating Sale Order</p>
...
{{--        ให้ select ใบ PO โดยไม่ต้องโชว์POดังนี้ <br>--}}
{{--        1.OrderStatus เสร็จสิ้นPaymentStatus เสร็จสิ้น <br>--}}
{{--        2. OrderStatusเสร็จ PaymentStatus ไม่เสร็จสิ้น <br>--}}
{{--        หลังselect จะโชว์ใบPOที่เลือก--}}
{{--        โชว์ข้อมูลลค. ชื่อบริษัท ที่อยู่ที่ส่ง  ข้อมูลPO (รหัสpoไรงี้) <br>--}}
{{--        โชว์ PO ITEM (รหัสสเปค หน่วย จำนวนที่สั่ง)ด้วย <br>--}}
...
{{--        หลังจากนั้นกด confirm ได้โลด <br>--}}
