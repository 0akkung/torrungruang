            ...
            <div style="background-color: #fff; padding: 1.25rem; border: 1px solid #e5e5e5; width: 100%; border-radius: 12px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                ...
                <div style="font-size: 1rem; font-weight: 600; display: flex; flex-direction: column; margin-top: 1rem;">
                    <div style="margin-top: 1rem;">
                        ...
                        <span style="color: white; width: 33.33%; padding-bottom: 0.5rem; background-color: #ff0000; font-weight: 600; padding: 0.5rem 1rem; border-radius: 9999px; margin-bottom: 0.5rem;">UNFinish</span>
                        @else
                        <span style="color: white; width: 33.33%; padding-bottom: 0.5rem; background-color: #00cc66; font-weight: 600; padding: 0.5rem 1rem; border-radius: 9999px; margin-bottom: 0.5rem;">Finish</span>
                        @endif
                    </div>
                </div>
