...
<div class="flex mb-5 justify-between">
    ...
    <div>
        <div class="flex">
            <a href="{{ route('po.printPDF',['po'=> $purchaseOrder]) }}" class="p-2 bg-po-button shadow-md text-black hover:bg-yellow-500 text-md font-bold rounded-lg px-4 inline">+ PDF</a>
        </div>
    </div>
</div>
<div class="w-full">
